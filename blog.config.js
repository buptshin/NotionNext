...
const BLOG = {
  ...
  HOME_BANNER_IMAGE: './2466303.jpg', // 首页背景大图，默认文件：/public/bg_image.jpg 。会被Notion中的封面图覆盖。
  ...
  CONTACT_EMAIL: 'ftxcnb@163.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/buptshin',
  CONTACT_TELEGRAM: '',
  ...
  WIDGET_PET_LINK:
    'https://github.com/xiazeyu/live2d-widget-models/blob/master/packages/live2d-widget-model-tororo/assets/tororo.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
